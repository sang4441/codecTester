...
import ssh.net.stun.dns.DClass;
import ssh.net.stun.dns.DMessage;
import ssh.net.stun.dns.DNSResolver;
import ssh.net.stun.dns.DResource;
import ssh.net.stun.dns.DResourceComparator;
import ssh.net.stun.dns.DType;
...
NAT     <--- / IP \<-----|  Test  |<--- /Resp\                Open
	...
	MessageAttribute errorCode = header.getMessageAttribute(MessageAttribute.MessageAttributeType.ERROR_CODE);
        ...
        if (useChangedAddress) {
            ...
            discoveryInfo.setPublicPort(mappedAddress.getPort());
            discoveryInfo.setLocalIpAddress(localAddr);
            discoveryInfo.setLocalPort(localPort);
