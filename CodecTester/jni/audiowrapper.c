...
jint Java_org_sipdroid_codecs_iLBC_audio_1codec_1init(JNIEnv *env,
...
jint Java_org_sipdroid_codecs_iLBC_audio_1encode(JNIEnv *env,
...
jint Java_org_sipdroid_codecs_iLBC_audio_1decode(JNIEnv *env,
